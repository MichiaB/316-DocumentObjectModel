...
const lightRoastBtn = document.getElementById("lightRoast");
const lightRoastAnswr = [
  "How Should I Know?",
...
lightRoast.addEventListner("click", function () {
  console.log(lightRoast);
});
for (let i = 0; i < lightRoast.length; i++) {
  console.log(lightRoast[i]);
}

// Medium Roast Button

const mediumRoastAnswr = [
